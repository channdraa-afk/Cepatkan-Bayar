        ...
        >
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              {isChef && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] sm:text-xs font-black bg-caramel text-cream border border-espresso">
                  <Utensils className="w-3 h-3 text-cream" /> Chef Aktif
                </span>
              )}
            </div>
        ...
        <div className="flex items-center gap-2">
          {isChef ? (
            <div className="flex items-center gap-1.5 sm:gap-2">
              <span className="px-2.5 py-1 rounded-xl text-xs font-black bg-amber-100 text-amber-950 border border-espresso flex items-center gap-1 shadow-tactile-sm">
                <span>🔥</span>
                <span>{cookingOrdersCount} Dimasak</span>
              </span>
              <button
                onClick={() => {
                  sound.playRemove();
                  if (onLogoutChef) onLogoutChef();
                }}
                className="btn-tactile-cream px-2.5 sm:px-3 py-1.5 text-xs font-black flex items-center gap-1.5 text-rose-700 hover:bg-rose-50"
                title="Keluar dari Mode Dapur / Chef"
              >
                <LogOut className="w-3.5 h-3.5" />
                <span className="hidden sm:inline">Keluar Dapur</span>
              </button>
            </div>
          ) : isCashier ? (
            <div className="flex items-center gap-1.5 sm:gap-2">
