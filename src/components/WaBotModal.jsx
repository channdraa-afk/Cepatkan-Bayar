      ...
      <div className="relative w-full max-w-xl bg-cream border-2 border-espresso rounded-2xl shadow-tactile-lg flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-4 sm:p-5 overflow-y-auto space-y-4">
          ...
          <div className="space-y-1.5 pt-1">
            ...
            <div className="p-3 bg-emerald-900 text-cream rounded-xl border-2 border-espresso text-[11px] font-sans leading-relaxed space-y-1 shadow-tactile-sm">
              ...
              <p>🚶 <strong>Yuk langsung menuju ke meja kasir stand untuk ambil pesananmu.</strong></p>
